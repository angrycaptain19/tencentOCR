...
class InstallRequirement(object):
    ...
    def build_location(self, build_dir):
        ...
        if self.req is None:
            ...
            return self._temp_build_dir.path
        name = self.name.lower() if self.editable else self.name
    ...
    def get_install_args(
        ...
        # type: (...) -> List[str]
        install_args = [sys.executable, "-u", '-c', SETUPTOOLS_SHIM % self.setup_py]
        ...
        install_args += ["--compile"] if pycompile else ["--no-compile"]
