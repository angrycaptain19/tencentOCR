...
def virtualenv_no_global():
    ...
    return bool(running_under_virtualenv() and os.path.isfile(no_global_file))
...
def distutils_scheme(dist_name, user=False, home=None, root=None,
    ...
    extra_dist_args = {"script_args": ["--no-user-cfg"]} if isolated else {}
    ...
    i.finalize_options()
    scheme = {key: getattr(i, 'install_' + key) for key in SCHEME_KEYS}
