...
class MultiDomainBasicAuth(AuthBase):
    ...
    def __call__(self, req):
        ...
        if username is None and password is None:
            ...
            username, password = netrc_auth or (None, None)
...
def unpack_file_url(
    ...
    from_path = already_downloaded_path or link_path
    content_type = mimetypes.guess_type(from_path)[0]
...
def _copy_dist_from_dir(link_path, location):
    ...
    # build an sdist
    setup_py = 'setup.py'
    sdist_args = [sys.executable, '-c', SETUPTOOLS_SHIM % setup_py, 'sdist']
