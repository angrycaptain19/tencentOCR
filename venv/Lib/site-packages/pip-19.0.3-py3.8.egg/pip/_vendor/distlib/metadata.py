...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def set(self, name, value):
        ...
        if name in _UNICODEFIELDS and name == 'Description':
    ...
    def check(self, strict=False):
        ...
        def are_valid_constraints(value):
            return all(scheme.is_valid_matcher(v.split(';')[0]) for v in value)
...
class Metadata(object):
    ...
    def __setattr__(self, key, value):
        ...
        if key in mapped:
            ...
            if key == 'keywords' and isinstance(value, string_types):
                value = value.strip()
    ...
    def _validate_mapping(self, mapping, scheme):
        ...
        missing = [
            ...
            if key not in mapping and scheme not in exclusions
        ]
            ...
            for e in entries:
                ...
                for r in rlist:
                    if not env and not extra:
                        ...
                        if env:
                            marker = '(%s) and %s' % (env, marker) if marker else env
    ...
    def write(self, path=None, fileobj=None, legacy=False, skip_unknown=True):
        ...
        self.validate()
        if legacy:
            legacy_md = self._legacy or self._to_legacy()
            if path:
